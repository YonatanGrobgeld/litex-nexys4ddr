...
set_property DRIVE 12 [get_ports {ddram_dq[0]}]
...
set_property DRIVE 12 [get_ports {ddram_dq[1]}]
...
set_property DRIVE 12 [get_ports {ddram_dq[2]}]
...
set_property DRIVE 12 [get_ports {ddram_dq[3]}]
...
set_property DRIVE 12 [get_ports {ddram_dq[4]}]
...
set_property DRIVE 12 [get_ports {ddram_dq[5]}]
...
set_property DRIVE 12 [get_ports {ddram_dq[6]}]
...
set_property DRIVE 12 [get_ports {ddram_dq[7]}]
...
set_property DRIVE 12 [get_ports {ddram_dq[8]}]
...
set_property DRIVE 12 [get_ports {ddram_dq[9]}]
...
set_property DRIVE 12 [get_ports {ddram_dq[10]}]
...
set_property DRIVE 12 [get_ports {ddram_dq[11]}]
...
set_property DRIVE 12 [get_ports {ddram_dq[12]}]
...
################################################################################
# IDELAY Control (required for DDR2 I/O delay elements)
################################################################################
...
set_property LOC G18 [get_cells IDELAYCTRL]
