...
class _CRG(Module):
    def __init__(self, platform, sys_clk_freq):
        ...
        self.clock_domains.cd_idelay = cd_idelay = ClockDomain()
        ...
        pll.create_clkout(cd_idelay, 200e6)

        self.submodules.idelayctrl = S7IDELAYCTRL(cd_idelay)
...
class BaseSoC(SoCCore):
    def __init__(self, platform, sys_clk_freq, 
        ...
        _dot8_v = os.path.join(os.path.dirname(__file__), "rtl", "VexRiscv_Dot8.v")
        _use_dot8_cpu = os.path.isfile(_dot8_v)
        ...
        # DDR2 PHY: 1:2 ratio (nphases=2), sys_clk=100MHz → DDR=200MHz=400MT/s.
        # Matches the proven litex-boards reference for Nexys4 DDR.
        ...
        self.add_sdram(
            "sdram",
            phy=self.ddrphy,
            module=MT47H64M16(sys_clk_freq, "1:2"),  # 1:2 ratio matches nphases=2
